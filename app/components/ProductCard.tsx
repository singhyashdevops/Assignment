...
export default function ProductCard({ product, view }: ProductCardProps) {
  ...
  return (
    <div
      className={`bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-lg transition-shadow duration-300 flex ${isList ? 'flex-row h-64' : 'flex-col h-full'}`}>
