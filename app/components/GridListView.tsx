...
export default function GridListToggle({ view, setView }: ToggleProps) {
  return (
    <div className="inline-flex rounded-md shadow-sm border border-gray-300 overflow-hidden bg-white">
      ...
      <button
        ...
        className={`px-4 py-2 text-sm font-bold border-l border-gray-300 transition-all duration-200 ${
          view === 'list'
